...
class viAnalysis:
    ...
    def fillParameters(self):
        ...
        for rr in data['reports']:
            ...
            if typehb[:5] == self.hybridtype and rr['module_usability'] == "Accepted":
                nAcc4Production+=1
            if typehb[:5] == self.hybridtype and rr['prototype_usability'] == "Accepted":
                nAcc4Prototype+=1
            if typehb[:5] == self.hybridtype and rr['hybrid_status'] == "Accepted":
                nAcc+=1
