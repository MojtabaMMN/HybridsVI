...
class viAnalysis:
    ...
    def fillParameters(self):
        ...
        nTotal2SFEH = 0
        nAcc4Production2SFEH = 0
        nAcc4Prototype2SFEH = 0
        nAcc2SFEH = 0
        nBC_acc = 0
        ...
        for rr in data['reports']:
            ...
            if rr['module_usability'] == "Accepted":
                nAcc4Production2SFEH+=1
            if rr['prototype_usability'] == "Accepted":
                nAcc4Prototype2SFEH+=1
            if rr['hybrid_status'] == "Accepted":
                nAcc2SFEH+=1
        ...
        parameters_2SFEH = ['Total', 'HybridOK','Accepted4Prototype','Accepted4Production','Barcode','Soldering quality','Alignment of components','AdhesiveFlex2CF']
        ValuesParam_2SFEH=[nTotal2SFEH,nAcc2SFEH,nAcc4Prototype2SFEH,nAcc4Production2SFEH,nBC_acc,nSolderingQuality_acc,nAlignment_acc,nAdhesiveFlexCF_acc]
    
        return parameters_2SFEH, ValuesParam_2SFEH
